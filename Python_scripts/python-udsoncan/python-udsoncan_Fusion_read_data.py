# this code read a DID (F188 ) on ford fusion HS2, Climate control.
# already tested and passed with Pcan tool
...
# example: https://udsoncan.readthedocs.io/en/latest/udsoncan/examples.html
# tested on 5/31/2020 with pcan 
