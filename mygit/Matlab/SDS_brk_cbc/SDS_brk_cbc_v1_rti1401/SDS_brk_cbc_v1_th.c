/************************ dSPACE target specific file *************************
   ...
   Include file .\SDS_brk_cbc_v1_rti1401\SDS_brk_cbc_v1_th.c :
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\SDS_brk_cbc_v1_rti1401\SDS_brk_cbc_v1_th.c is for ST).
# endif
