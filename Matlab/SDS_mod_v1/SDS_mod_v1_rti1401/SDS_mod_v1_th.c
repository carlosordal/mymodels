/************************ dSPACE target specific file *************************
   ...
   Include file .\SDS_mod_v1_rti1401\SDS_mod_v1_th.c :

   Task Configuration file for model : SDS_mod_v1

   RTI1401 7.10 (02-May-2018)/2.17
   02-Aug-2019 09:10:03
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\SDS_mod_v1_rti1401\SDS_mod_v1_th.c is for ST).
# endif
