...
#define RTB_STRUCTURE_NAME             SDS_mod_v1_B
#define RTP_STRUCTURE_NAME             SDS_mod_v1_P
...
static void rti_mdl_initialize_io_boards(void)
{
  ...
  can_type1_msg_M1[CANTP1_M1_C1_TX_STD_0X359] = can_tp1_msg_tx_register
    (can_type1_channel_M1_C1, 1, 857, CAN_TP1_STD, (CAN_TP1_TIMECOUNT_INFO),
  ...
  can_type1_msg_M1[CANTP1_M1_C1_RX_STD_0X334] = can_tp1_msg_rx_register
    (can_type1_channel_M1_C1, 0, 820, CAN_TP1_STD, (CAN_TP1_DATA_INFO|
  ...
  can_type1_msg_M1[CANTP1_M1_C1_RX_STD_0X35A] = can_tp1_msg_rx_register
    (can_type1_channel_M1_C1, 2, 858, CAN_TP1_STD, (CAN_TP1_DATA_INFO|
      CAN_TP1_DATA_INFO|CAN_TP1_TIMECOUNT_INFO|CAN_TP1_TIMECOUNT_INFO),
     CAN_TP1_NO_SUBINT);

  /* dSPACE RTICAN RX Message Block: "CBC_PT1" Id:820 */
  SDS_mod_v1_B.SFunction1_o24 = 0;     /* processed - flag */
  SDS_mod_v1_B.SFunction1_o25 = 0;     /* timestamp */
  SDS_mod_v1_B.SFunction1_o26 = 0;     /* deltatime */

  /* dSPACE RTICAN RX Message Block: "SDS_CBC_STAT" Id:858 */
  SDS_mod_v1_B.SFunction1_o12_c = 0;   /* processed - flag */
  SDS_mod_v1_B.SFunction1_o13_o = 0;   /* timestamp */
  SDS_mod_v1_B.SFunction1_o14_i = 0;   /* deltatime */
